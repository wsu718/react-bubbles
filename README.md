...
A token is used to generate secured authentication and communications between the client and server. 
...
Servers process incoming requests and generally store and process data from databases.
